"""Grade-manifest tests for the learning_social batch.

Learning & Notes (38) + Social & Content (38) = 76 minions. The rubric
...
MANIFEST_PATH = (
    ...
    / "automation"
    / "grade_data"
    / "learning_social.json"
)

BATCH_CATEGORIES = ("Learning & Notes", "Social & Content")
...
def test_manifest_loads_and_batch_matches():
    data = _load_manifest()
    assert data["batch"] == "learning_social"
