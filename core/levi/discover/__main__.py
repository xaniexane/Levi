...
SAMPLE_ITEMS = [
    {"id": "sample-note-1", "title": "Field notes: repairing a 1987 ThinkPad keyboard",
     "kind": "note", "tags": ["repair", "hardware"], "added_at": "2026-06-01",
     "source": "sample", "blurb": "Forgotten method: bolt-modding buckling springs."},
    {"id": "sample-paper-1", "title": "The lost art of the .plan file",
     "kind": "paper", "tags": ["internet-history", "finger"],
     "added_at": "2026-06-02", "source": "sample",
     "blurb": "Before status updates, there was finger."},
    {"id": "sample-book-1", "title": "Gopher: the protocol that almost won",
     "kind": "bookmark", "tags": ["internet-history", "protocols"],
     "added_at": "2026-06-03", "source": "sample",
     "blurb": "What the web killed, and what it cost."},
    {"id": "sample-note-2", "title": "Recipe: grandmother's sourdough, annotated",
     "kind": "note", "tags": ["food", "family"], "added_at": "2026-06-04",
     "source": "sample", "blurb": "Hydration percentages in the margins."},
    {"id": "sample-paper-2", "title": "Smalltalk-80: the humane environment",
     "kind": "paper", "tags": ["programming", "history"],
     "added_at": "2026-06-05", "source": "sample",
     "blurb": "The whole system fit in your head."},
    {"id": "sample-book-2", "title": "HyperCard stacks archive",
     "kind": "bookmark", "tags": ["programming", "history", "hypercard"],
     "added_at": "2026-06-06", "source": "sample",
     "blurb": "Everyone was a programmer for a while."},
    {"id": "sample-mem-1", "title": "Idea: porch concerts for the block",
     "kind": "memory", "tags": ["community", "music"], "added_at": "2026-06-07",
     "source": "sample", "blurb": "Low-fi, high-neighbor."},
    {"id": "sample-note-3", "title": "Notes on mending clothes visibly",
     "kind": "note", "tags": ["craft", "repair"], "added_at": "2026-06-08",
     "source": "sample", "blurb": "Sashiko as philosophy."},
    {"id": "sample-paper-3", "title": "Usenet: governance without owners",
     "kind": "paper", "tags": ["internet-history", "governance"],
     "added_at": "2026-06-09", "source": "sample",
     "blurb": "The great renaming and what it taught."},
    {"id": "sample-book-3", "title": "Demoscene: 64k of impossible",
     "kind": "bookmark", "tags": ["programming", "art", "demoscene"],
     "added_at": "2026-06-10", "source": "sample",
...
def cmd_discover(a) -> int:
    ...
    try:
        digest, markdown = generate_digest(
            items, week, home,
            seed=a.seed, count=a.count,
            per_kind_cap=a.per_kind_cap, per_tag_cap=a.per_tag_cap,
...
def main(argv=None) -> int:
    ...
    p.add_argument("--seed", type=int, default=None, help="override the week-derived seed")
