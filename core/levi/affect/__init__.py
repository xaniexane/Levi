...
__all__ = [
    "EmotionReading", "detect", "EMOTIONS",
    "DIMENSIONS", "SelfModel", "SessionEI", "honesty_check",
    "PolicyDecision", "evaluate",
    "REGISTERS", "RegisterSuggestion", "check_wit_safety",
    "detect_rapport", "detect_repair", "rapport_note", "suggest_register",
    "affect_hint", "growth_signals", "modulate", "record_signal",
]
