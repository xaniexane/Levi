...
own concept: the integrated-intelligence adapter
(``levi.dynasty.adapter``) is unchanged, and operators that wrap
outside minds set ``is_foreign = True`` (see below) — they are not
``xi``.
