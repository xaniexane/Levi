...
//#endregion
export { GLOBAL_TSR, HeadContent, Outlet, RouterProvider, Scripts, TSR_SCRIPT_BARRIER_ID, _getRenderedMatches, bindSsrResponseToRequest, createFileRoute, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createRootRoute, createRouter, createSieveCache, decodePath, defineHandlerCallback, dehydrateSsrMatchId, disposeSsrResponseDetached, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isDangerousProtocol, isNotFound, isRedirect, isSsrResponse, lazyRouteComponent, normalizeSsrResponse, parseRedirect, renderRouterToStream, replaceSsrResponse, require_jsx_runtime, require_react, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody, useRouter };
