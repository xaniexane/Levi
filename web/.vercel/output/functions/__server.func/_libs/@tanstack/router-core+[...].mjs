import { GLOBAL_TSR, TSR_SCRIPT_BARRIER_ID, _getRenderedMatches, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createSieveCache, decodePath, dehydrateSsrMatchId, getStylesheetHref, invariant, rootRouteId } from "./react-router+[...].mjs";
