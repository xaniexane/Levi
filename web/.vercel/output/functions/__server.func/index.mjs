...
import { H3Core, HTTPError, composeMiddleware, createMatcherFromFind, defineLazyEventHandler, headers, memoizeRouteRulesMatcher, toEventHandler } from "./_libs/h3+srvx.mjs";
...
var _lazy_a218b4dbeeb1786c = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_a218b4dbeeb1786c
	};
	return ((_m, p) => {
		return {
			data,
